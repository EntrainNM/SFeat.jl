...
ALL = readdir(raw"C:\Users\hemad\Desktop\Master\Experiments\Exp1\data\CASD", join=true)
# parentFolder = raw"C:\Users\hemad\Desktop\Master\Experiments\Exp1\data\CNT\CNT008_06252018"

for parentFolder in ALL
    ...
    WordS1_corrected[ [i[4] == 0.0 for i in WordS1_corrected] ];
